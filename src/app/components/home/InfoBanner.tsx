  ...
  return (
    <Container>
      ...
      <TextContainer>
        ...
        <Text>
          Fleuriste sur le secteur d’Arras, en format atelier. Nous avons à
          coeur de vous proposer des fleurs françaises dans le respect de la
        ...
        <Text>
          ...
          priorisons l’utilisation de fleurs françaises. Dans ce sens également,
          nous sommes sans cesse à la recherche de producteurs locaux dans la
          fleur coupée.
        </Text>
      </TextContainer>
    </Container>
